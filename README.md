...
## Development environment and release process
 ...
 - create virtualenv with Flask and calendonator installed into it (latter is installed in
...
install it (`pip install calendonator.tar.gz`), ensure that configuration file exists and
`CALENDONATOR_SETTINGS` environment variable points to it, ensure that user has access to the
